...
thing to our sums-of-squares example:
...
high-level and informal for now. (There are also "typed" [versions of the
lambda calculus][TLC] but we don't need to actually compute stuff.)
