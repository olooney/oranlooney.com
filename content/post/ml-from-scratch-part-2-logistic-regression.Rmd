...
summation over training examples above -- but has the advantage of being harder
to read. No wait -- I mean it has the advantage of being naturally translated
into vectorized numpy code. Sorry about that.
