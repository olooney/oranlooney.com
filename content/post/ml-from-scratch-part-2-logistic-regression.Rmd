...
it is amenable to numerical methods, which we will cover in great detail.
...
is this fairly expensive, but it violates the basic rule for making gradient
descent algorithm fast: 
