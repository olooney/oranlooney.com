...
The `[8, 3]` model achieves 95% accuracy on the training set and 91% accuracy on the
test set. That's two hidden layers of 8 nodes and 3 nodes respectively. All
layers are fully connected, so there's a 9x3 matrix with 27 parameters
connecting them, plus the 4x1 connections to the output node and the 21x8
connections to the input layer, making for 199 parameters in all.
