...
[presentations.][3B1B] My intention with this article is simply to derive the
backpropagation algorithm, implement a working version from scratch, and to
discuss how we can mitigate some of the dangers introduced when we move beyond
logistic to more complex representations.
