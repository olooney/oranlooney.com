...
$$ \mathbf{L} = \mathbf{Q} \sqrt{\mathbf{\Lambda}} $$
...
The [wine quality data set][WQD] consists of 178 wines, each quantified in
terms of 13 different objective chemical or optical properties, such of the
concentration of alcohol or the hue and intensity of the color. Each has been
assigned to one of three classes depending on a subjective judgement of
quality.

This is only a toy data set, and 13 is perhaps not yet totally unmanageable, but
it certainly more than it is convenient to visualize or think about properly.
We'd like to get that down to something manageable: one, two, or perhaps three
dimensions.
...
It is clear that this dataset exhibits significant [multicollinearity][MC], with every feature exhibiting high
...
TODO: Scree
the Kaiser Rule is of course a train wreck, but the alternatives aren't much better.
