...
Did it work? Well to visualize them, let's put them into a `data.frame` and expand them out to three
...
title(paste("Squared Gaussian Integers", n))
```
