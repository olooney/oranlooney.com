...
values for all parameters... but in the end we still had to understand our
model in terms of complex numbers. This is not infrequent and hopefully these
examples have demonstrated that its extremely helpful familiarize yourself with
R's capabilities in this regard well ahead of encountering any analysis where
