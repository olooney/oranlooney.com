...
with one input node, one hidden layer with a sigmoid activation function,
...
Feel free to compare the above equations to the equations for a neural network described in the [previous article on neural networks][MLFS3] if you need further convincing.

Moreover, there is a famous [universal approximation theorem][UAT] for this exact 
